...
class Video_Stripformer_Plus(nn.Module):
    def __init__(self, dim_1=64, dim_2=128, dim_3=256, head_num=8):
        super(Video_Stripformer_Plus, self).__init__()
        ...
        self.block_5 = Spatial_Temporal_Stripformer(dim_3, head_num)
        self.block_6 = Spatial_Temporal_Stripformer(dim_3, head_num)
        self.block_7 = Spatial_Temporal_Stripformer(dim_3, head_num)
        self.block_8 = Spatial_Temporal_Stripformer(dim_3, head_num)
        self.block_9 = Spatial_Temporal_Stripformer(dim_3, head_num)
        self.block_10 = Spatial_Temporal_Stripformer(dim_3, head_num)
